...
if(trim($email) == '') {
	...
	exit();
} else if(trim($regimen) == '') {
	echo '<div class="error_message">Attention! Please select a regimen.</div>';
	exit();
} else if(trim($phone) == '') {
...
$address = "hello@untanglelife.com";
...
// send email
mail("redball.future@gmail.com","My test",wordwrap("test",70));
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<p>Thank you $email, your message has been submitted to us.</p>";
	echo "</div>";
	echo "</fieldset>";
} 
else {
